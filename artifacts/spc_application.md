...
**Draft:**
> I want to explore the foundational data layer required to unblock physical infrastructure development in the US. Right now, the race to build gigawatt AI data centers is acutely bottlenecked by opaque spatial, political, and physical constraints (climate risk, zoning friction, grid capacity).
> 
> My "Request for Curiosity" is this: Can we build the foundational data API for the physical world to instantly scope the feasibility of new AI infrastructure? At TACC and my unfunded startup, Homecastr, I built national-scale spatial ML models to quantify flood risk and real estate valuations. I want to use the SPC -1 to 0 phase to explore pointing Homecastr's core probabilistic architecture directly at the AI infrastructure boom—building the "Plaid for physical risk" that allows hyperscalers and infrastructure developers to programmatically query the true cost and friction of breaking ground on massive data centers. Given SPC's track record of incubating foundational B2B data infrastructure (Unit21) and frontier spatial/climate tech (Muon Space), this architecture sits perfectly at the intersection of those proven ecosystems.
...
> oppsAlert: A machine learning pipeline designed to predict NIMBYism and homeowner zoning protests. I was curious why some high-density housing developments passed while others faced massive resistance, so I scraped 15 years of municipal zoning records, public hearing transcripts, and property tax data from the City of Austin. I built a natural language processing and spatial lag model that accurately predicted which parcels would trigger organized neighborhood opposition. It proved my core thesis that hyper-local political friction could be mathematically priced into development risk. This project is the direct proof-of-concept for the "physical risk API" I want to build at SPC—I plan to apply this exact NLP/spatial methodology to predict the local NIMBY opposition currently bottlenecking gigawatt AI data centers.
