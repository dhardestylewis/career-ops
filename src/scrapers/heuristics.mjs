export const getDeterministicMappings = (profileConfig, domainOverrides) => [
    ...
    { question: /plan to work remotely|work remotely/i, value: 'No' },
    ...
    { question: /country where you currently reside|currently reside|current residence|where you currently live/i, value: domainOverrides?.country || 'United States' },
    { question: /country or countries you anticipate working in|anticipate working in|work in the location/i, value: domainOverrides?.country || 'United States' },
    ...
    { question: /^degree\b|highest level of education/i, value: profileConfig?.candidate?.degree_level || profileConfig?.candidate?.degree || 'Bachelor' },
    { question: /^discipline\b|highest level degree in/i, value: 'Computer Science' },
    { question: /^school\b/i, value: profileConfig?.candidate?.school || profileConfig?.candidate?.university || 'University of Texas at Austin' },
    ...
    { question: /current.*employer|previous employer|who is your current or previous employer/i, value: profileConfig?.candidate?.company || 'Homecastr' },
    { question: /current.*job title|previous job title|who is your current or previous job title|job title/i, value: profileConfig?.candidate?.title || 'Founder' },
    ...
    { question: /^degree/i, value: domainOverrides?.degree || profileConfig?.candidate?.degree_level || profileConfig?.candidate?.degree || 'Bachelor' },
