...
Draft and sent-history workspace. Sent items are mirrored here for traceability. Check `data/outreach/log.md` for the live-send ledger. The send preflight will hard-stop if a packet tries to resend something already mirrored here and recorded in the live log.
...
## Li-Yun (James) Wang, PhD / LinkedIn reply

**To:** Li-Yun (James) Wang, PhD

**Channel:** LinkedIn message thread

**Status:** Draft only, not sent

**Relationship:** 1st-degree LinkedIn connection; warm thread opened from his July 5, 2026 collaboration post.

**Last touch:** replied on July 5, 2026 at 4:36 PM that the project is research-oriented and aimed at a workshop or conference.

**Why now:** he framed the project as a research collaboration, not a work pitch.

**Hook:** workshop-style paper framing and experiment design.

**Proof point:** Homecastr diffusion forecasting plus probabilistic evaluation; Columbia CVAE latent-factor and GRPO research.

**Ask:** compare notes on experiment design, evaluation, or workshop framing.

**Avoid:** any job pitch, any claim about unpublished infrastructure details not backed by the CV or bio, or stacking multiple asks.

**Next follow-up:** answer directly in-thread if the user wants to continue; otherwise leave it as watch.

**Subject:** Re: research collaboration

```text
Hi Li-Yun - that makes sense. My overlap is on the research and evaluation side: at Homecastr I've been building a nationwide diffusion forecasting model with a probabilistic evaluation suite, and at Columbia I've also been doing research on CVAE latent factor models and GRPO fine-tuning.

If it would be useful, I'd be glad to compare notes on experiment design, evaluation, or how you're thinking about framing the work for a workshop-style paper.
