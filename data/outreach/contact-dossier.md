...
### Li-Yun (James) Wang, PhD

contact: Li-Yun (James) Wang, PhD
relationship: 1st-degree LinkedIn connection; warm thread opened from his July 5, 2026 collaboration post
lane: research collaboration reply
source_refs: https://www.linkedin.com/in/li-yunwang/ ; data/outreach/log.md
last_touch: Li-Yun replied on July 5, 2026 at 4:36 PM that the project is research-oriented and aimed at a workshop or conference.
why_now: He responded and clarified that this should be framed as a publication-oriented collaboration, not a work pitch.
hook: Research-oriented collaboration with a workshop or conference outcome.
proof_point: At Homecastr I built a nationwide diffusion forecasting model with a probabilistic evaluation suite, and at Columbia I have also been doing research on CVAE latent factor models and GRPO fine-tuning.
ask: Offer to compare notes on experiment design, evaluation, or workshop framing.
...
status: replied
action_state: draft
next_followup: Answer directly in-thread if the user wants to continue; otherwise leave it as watch.
spc_affiliation: not checked; non-job research lane
spc_checked_at: n/a
